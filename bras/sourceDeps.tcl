...
##   (`cc -xM' on Solaris) and generate newer-rules.
##
##   All parameters except the first are treated as suffixes of
##   dependencies that need not be included in the rule. Typical
##   examples would be `/usr' and `/usr/local'. Dependencies starting
##   with these suffixes are not included in the generated rule.
##
