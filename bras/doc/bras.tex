...
%%%%%%%%%%%%%%%%%%%%%%%%
%
% $Revision: 1.16 $, $Date: 1999/01/23 19:27:33 $
%
%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{verbatim}
This will set \texttt{prefix} to \texttt{\$env(prefix)} or, if it does
not exits, to \texttt{/usr/local}. If you require an environment
