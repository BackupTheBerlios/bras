...
%%%%%%%%%%%%%%%%%%%%%%%%
%
% $Revision: 1.30 $, $Date: 2001/07/29 12:33:51 $
%
%%%%%%%%%%%%%%%%%%%%%%%%
...
files can be found in the files \Indextt{c2o.rule} and
\Indextt{cdeps.rule}. To use them, include them both into your
\brasfile{} with
\begin{quote}
...
\index{consider!explicitly calling}
\label{secConsider}
...
\begin{verbatim}
  Make libs {[updated {libR.a libS.a libT.a}]} {
    #Nothing to be done here, libs is not a file target. It only 
    #serves as a shortcut to combine in an OR-like fashion the results 
    #of considering the dependencies.
  }
