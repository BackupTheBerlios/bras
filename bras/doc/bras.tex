...
%%%%%%%%%%%%%%%%%%%%%%%%
%
% $Revision: 1.21 $, $Date: 2000/03/08 22:38:46 $
%
%%%%%%%%%%%%%%%%%%%%%%%%
...
\item[Step 1] derives a dependency from \texttt{bla.o}. It calls a
  ...
  \begin{quote}
    \texttt{GenDep}\textit{deptag} \texttt{\$target}
  \end{quote}
  ...
  \texttt{GenDep\textit{deptag}} looks like
  \begin{quote}
    \verb|proc GenDep|\textit{deptag} \verb|{target} {|\\
